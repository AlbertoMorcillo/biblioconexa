  ...
  <div class="row">
    ...
    <div class="col-lg-9 mb-3 secciones-enlaces" aria-label="Sección de enlaces">
      <div class="row">
        ...
        <div class="col-md-3 seccion-enlace" aria-label="Sección de enlaces sobre la gestión de tus libros y préstamos">
          <h5>Tu gestión</h5>
          <ul class="nav flex-column">
            <li class="nav-item mb-2"><a href="{{ route('admin.mis-libros') }}" class="nav-link p-0">Mis libros</a></li>
          </ul>
        </div>
      </div>
    </div>
