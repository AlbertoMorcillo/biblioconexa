...
<form>
    ...
    <div class="form-floating my-3">
    <input type="email" class="form-control rounded-pill" id="email" name="email" placeholder="name@example.com">
    ...
    <div class="form-floating my-3">
    <input type="password" class="form-control rounded-pill" id="passwordRepetida" name="passwordRepetida" placeholder="Password repetida">
